...
hi DiffText                      guibg=#4C4745 gui=none,none
...
hi MatchParen      guifg=#000000 guibg=#666666 gui=none
...
hi noned           guifg=#808080               gui=none
...
if s:molokai_original == 1
   ...
   hi NonText         guifg=#444444 guibg=#272822
else
   ...
   hi NonText         guifg=#444444 guibg=#1B1D1E
end

" user custom
hi VertSplit       guifg=#080808 guibg=#080808 gui=none
hi StatusLine      guifg=#444444 guibg=#ffffff
hi StatusLineNC    guifg=#080808 guibg=#666666
hi Pmenu           guifg=#ffffff guibg=#3f3f3f
hi PmenuSel        guifg=#66D9EF guibg=#333333
" html
...
" js
hi javaScriptIdentifier   guifg=#66D9EF
hi javaScriptNumber       guifg=#AE81FF

" Distribution
if s:molokai_original == 1
  hi MatchParen      guifg=#ffffff guibg=#272822 gui=underline
  hi NonText         guifg=#272822
else
  hi MatchParen      guifg=#ffffff guibg=#1B1D1E gui=underline
  hi NonText         guifg=#1B1D1E
  hi Comment         guifg=#666666
end
" custom
"hi URL gui=underline guifg=#AE81FF
hi URL gui=underline guifg=#80a0ff
...
if &t_Co > 255
   ...
   hi noned      ctermfg=244               cterm=none
